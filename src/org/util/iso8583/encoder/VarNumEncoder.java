...
public final class VarNumEncoder extends Encoder {

	private static final VarNumEncoder DOUBLE_CHAR_ENCODER = new VarNumEncoder(2);
	private static final VarNumEncoder TRIPLE_CHAR_ENCODER = new VarNumEncoder(3);
	
	public static final VarNumEncoder getInstanceOfDouble() {
		return DOUBLE_CHAR_ENCODER;
	}
	
	public static final VarNumEncoder getInstanceOftriple() {
	...
	private VarNumEncoder(int lenLen) {
		this.lenLen = lenLen;
