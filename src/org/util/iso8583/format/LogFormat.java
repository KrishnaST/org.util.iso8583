...
public final class LogFormat extends ISOFormat {

	private static final ISOFormat LOG_FORMAT = new LogFormat();
	...
	protected LogFormat() {
		...
		length[11]   = 6;
		encoder[11] = CHAR.encoder;

		length[12]   = 6;
		encoder[12] = CHAR.encoder;

		length[13]   = 4;
		encoder[13] = CHAR.encoder;
